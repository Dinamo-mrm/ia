...
perplexity = PerplexityClient(key=perplexity_api_key)
...
9. perplexity_search: Perform a web search using the Perplexity API for up-to-date information.
...
- Proactively use perplexity_search when you need up-to-date information or additional context.
...
4. Tool Usage:
   ...
   - Use perplexity_search proactively for up-to-date information.
...
tools = [
    ...
    # }
    {
        ...
        "description": "Perform a web search using the Perplexity API to get up-to-date information or additional context.",
        "input_schema": {
            "type": "object",
            "properties": {
                "query": {
...
async def execute_tool(tool_name: str, tool_input: Dict[str, Any]) -> Dict[str, Any]:
    try:
        ...
        if tool_name == "create_files":
            ...
            result = perplexity_search(tool_input["query"])
